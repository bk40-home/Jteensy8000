...
// Reverse lookup — O(N) linear scan by CC alias. Used for firmware→editor
// PARAM_VALUE echo (UI rate, not audio-hot). Returns nullptr if no entry
// maps to this CC (e.g. SysEx-only params, or CCs not in the map).
